...
/* ─── Data ─── */
const caseStudies = [
    { id: "salesrabbit-unify", hidden: true, company: "SalesRabbit", title: "Unifying 3 Products", subtitle: "Merging Acquisitions Into One Platform", year: "2023\u20132024", role: "Lead Product Designer", timeline: "Q2 2023 \u2013 Q3 2024", team: "Cross-functional \u00b7 3 product teams", skills: ["Systems Thinking","Product Strategy","IA","Multi-Persona Design"], tags: ["Acquisitions","Platform","Strategy"], color: "#8B5CF6", summary: "Led design integration of two acquired products (a roofing CRM and a quoting tool) into SalesRabbit\u2019s core platform, reconciling different codebases, data models, and user personas.", heroLabel: "01",
  ...
  { id: "salesrabbit-team", company: "SalesRabbit", title: "Product Design Team", subtitle: "From Sales-led to Product-led", year: "2022–Present", role: "Lead Product Designer", timeline: "Oct 2022 – Present", team: "2 reports · 15 eng & PMs", heroVideo: "/videos/salesrabbit-team/SR_Team_Hero.mp4", heroPoster: "/videos/salesrabbit-team/SR_Team_Hero_poster.jpg", heroLogo: "/images/salesrabbit-team/SR_Logo.svg", skills: ["Leadership","Design Systems","Team Building","AI Workflows"], tags: ["Leadership","Team Building","AI Workflows"], color: "#F4B56F", summary: "Rebuilt the platform and team for product-led growth: career paths, unified Flutter design system, AI-assisted workflows.", heroLabel: "04",
  ...
  { id: "cricut-shop", company: "Cricut", title: "Shop Nav", subtitle: "E-Commerce Navigation Redesign", year: "2022", role: "Senior UX Designer", timeline: "2017 – 2022", team: "Cross-functional", heroVideo: "/videos/cricut-shop/Cricut_Hero.mp4", heroPoster: "/videos/cricut-shop/Cricut_Hero_poster.jpg", heroLogo: "/videos/cricut-shop/cricut.svg", skills: ["E-Commerce","Information Architecture","Navigation","UX Research"], tags: ["E-Commerce","IA","Navigation"], color: "#10B981", summary: "Restructured Cricut’s shop navigation from a flat catalog into a faceted, filterable experience for millions of crafters.", heroLabel: "04",
        ...
        <div style={{ maxWidth: maxW, margin: "0 auto", width: "100%", position: "relative" }}>
          {ed && !mob ? (
            ...
            <>
              ...
              <FadeIn delay={0.1}>
                <div style={{ position: "relative", minHeight: "160px", textAlign: br ? "left" : "inherit" }}>
                  <p style={{ fontFamily: hf, fontSize: mob ? (br ? "44px" : ed ? "32px" : "clamp(40px, 12vw, 56px)") : "clamp(64px, 9vw, 120px)", fontWeight: 700, fontStyle: br ? "normal" : "italic", color: br ? "#FF0000" : t.heroText, lineHeight: 1.15, letterSpacing: br ? "-0.04em" : "-0.03em", textWrap: "balance", textTransform: br ? "uppercase" : "none", overflowWrap: "break-word", wordBreak: "break-word",
                    opacity: phrasePhase === "visible" ? 1 : 0, transform: phrasePhase === "exit" ? "translateY(-16px)" : phrasePhase === "enter" ? "translateY(16px)" : "translateY(0)", transition: phrasePhase === "enter" ? "none" : "transform 0.4s cubic-bezier(0.16,1,0.3,1), opacity 0.35s",
                  }}>
    ...
    <div style={{ paddingTop: mob ? "64px" : "80px" }}>
      ...
      <section style={{ padding: `${mob ? "36px" : "48px"} ${px} ${br ? (mob ? "100px" : "120px") : (mob ? "60px" : "80px")}`, maxWidth: sideMax, margin: "0 auto", borderTop: `1px solid ${t.border}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
          ...
          {(() => { const idx = caseStudies.findIndex(c => c.id === cs.id); const n = caseStudies[(idx+1)%caseStudies.length]; return <button onClick={() => n.isExternal ? window.open(n.externalUrl,"_blank") : goBack("case-" + n.id)} style={{ background: "none", border: `1px solid ${t.border}`, borderRadius: "8px", padding: "12px 24px", fontFamily: t.bodyFont, fontSize: "13px", color: t.textDim, cursor: "pointer", display: "flex", alignItems: "center", gap: "8px" }}>Next: {n.title} <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M5 12h14m0 0l-7-7m7 7l-7 7"/></svg></button>; })()}
        </div>
      </section>
    </div>
  );
